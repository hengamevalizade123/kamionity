...
?>
	<section class="o-section c-section--main-page pt-0">
		<div class="c-about d-flex direction-column gap-md c-post">
			<div class="c-about__img">
				<img src="<?php echo get_template_directory_uri(); ?>/assets/images/hero-camiunity.webp"
					 alt="کامیونیتی">
			</div>
			<div class="o-section__wrapper">
				...
				<div class="c-about__content-short-desc c-post__content">
					<?php echo get_field('short_desc') ?>
				</div>

				<div class="c-services">
					<ul class="d-flex gap-md p-0">
						<li class="d-flex gap-md item-center">
<span class="d-flex content-center item-center">
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <path
		...
		stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/> </svg>
							...
							<div class="c-services__txt d-flex direction-column content-between gap-sm flex-1">
								<h3 class="m-0">
									فروش اقساطی
								</h3>
								<p class="m-0 font-sm">
									با شرایط ویژه و پرداخت آسان، اتاق باری موردنظر خود را اقساطی خریداری کنید.
								</p>
							</div>
						</li>
						<li class="d-flex gap-md item-center">
...
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <path
		...
		stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/> </svg>
							...
							<div class="c-services__txt d-flex direction-column content-between gap-sm flex-1">
								...
								<p class="m-0 font-sm">
									با ۱۸ ماه ضمانت معتبر، خیالتان از کیفیت و دوام اتاق‌های باری راحت باشد.
								</p>
							</div>
						</li>
						<li class="d-flex gap-md item-center">
...
<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"> <path
		...
		stroke="#292D32" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/> </svg>
							...
							<div class="c-services__txt d-flex direction-column content-between gap-sm  flex-1">
								...
								<p class="m-0 font-sm">
									سفارشی‌سازی ابعاد، متریال و جزئیات را فراهم کرده‌ایم تا بهترین انتخاب را داشته
									باشید.
								</p>
							</div>
						</li>
